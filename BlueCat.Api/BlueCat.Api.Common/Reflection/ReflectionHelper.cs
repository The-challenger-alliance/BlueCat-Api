...
using BlueCat.Api.Common.IO;

namespace BlueCat.Api.Common.Reflection
{
...
"{0}Message:{2}<br/>" +
 "{0}InnerException:<br/>{5}",
        ...
        public static void SerializeException(Exception err, XElement par)
        {
            ...
            if (err is BlueCatSystemException)
            {
                BlueCatSystemException serr = err as BlueCatSystemException;
